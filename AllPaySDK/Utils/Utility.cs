...
namespace AllPaySDK.Utils
{
    public static class Utility
    {

        //private const string mysecurityKey = "MyTestSampleKey";
        //97417a65a37e07fedd3d0e8b
        private const string mysecurityKey = "97417a65a37e07fedd3d0e8b";

        public static string Encrypt3DES(string TextToEncrypt, string encryptionKey)
        {
            ...
            byte[] MysecurityKeyArray = MyMD5CryptoService.ComputeHash
               (UTF8Encoding.UTF8.GetBytes(encryptionKey));
        ...
        public static string Decrypt3DES(string TextToDecrypt, string encryptionKey)
        {
